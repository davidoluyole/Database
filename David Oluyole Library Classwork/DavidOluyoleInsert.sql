...
insert into books(bookID, bookName, bookauthor) values
...
insert into staff(staffID, Name, email, phone, address, job) values
...
insert into user(userID, name, gender, address, phone) values
...
(1, 9, '2022-2-2', '2022-4-6', 1, 3),
(2, 12, '2021-2-3', '2022-4-7', 2, 1),
(3, 9, '2021-2-4', '2022-4-8', 3, 1),
(4, 7, '2021-2-5', '2022-4-9', 4, 5),
(5, 8, '2021-2-6', '2022-4-10', 5, 3),
(6, 17, '2021-2-7', '2022-4-11', 6, 5),
(7, 12, '2021-2-8', '2022-4-12', 7, 3),
(8, 6, '2021-2-9', '2022-4-13', 8, 1),
(9, 14, '2021-2-10', '2022-4-14', 9, 5),
(10, 13, '2021-2-11', '2022-4-15', 10, 1),
(11, 9, '2021-2-12', '2022-4-16', 11, 5),
(12, 15, '2021-2-13', '2022-4-17', 12, 3),
(13, 14, '2021-2-14', '2022-4-18', 13, 5),
(14, 10, '2021-2-15', '2022-4-19', 14, 1),
(15, 10, '2021-2-16', '2022-4-20', 15, 3),
(16, 11, '2021-2-17', '2022-4-21', 16, 1),
(17, 8, '2021-2-18', '2022-4-22', 17, 3),
(18, 14, '2021-2-19', '2022-4-23', 18, 5),
(19, 19, '2021-2-20', '2022-4-24', 19, 1),
(20, 17, '2021-2-21', '2022-4-25', 20, 5);